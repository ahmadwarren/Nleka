...
import Restos from './asset/Restos'; 
        ...
        <Router> 
            <nav>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                Home</Link>
              <Link to={'./resto'} className='menu-btn'>
          ...
          <Routes>        
            ...
            <Route exact path='/resto' element={< Restos />}></Route>
